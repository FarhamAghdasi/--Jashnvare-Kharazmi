            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">ویرایش پنل کاربری</a></li>
                    </ol>
                </div>
                <!-- row -->
                <!--  -->
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <form id="logout-form" action="" method="post" role="form">
                                            <li style="margin: 5px">
                                                <h2>نام و نام خانوادگی جدید</h2>
                                                <input type="text" class="newname form-control input-default"
                                                    placeholder="<?php echo $first_name ?>">
                                            </li>
                                            <li style="margin: 5px">
                                                <h2>نام خانوادگی جدید</h2>
                                                <input type="text" class="lastname form-control input-default"
                                                    placeholder="<?php echo $last_name ?>">
                                            </li>
                                            <li style="margin: 5px">
                                                <h2>ایمیل</h2>
                                                <input type="email" class="gmail form-control input-default"
                                                    placeholder="">
                                            </li>
                                            <li style="margin: 5px">
                                                <h2>شماره موبایل</h2>
                                                <input type="number" class="phoneNumber form-control input-default"
                                                    placeholder="">
                                            </li>
                                            <li style="margin: 5px">
                                                <h2>رمز عبور فعلی</h2>
                                                <input type="password" class="newpassword form-control input-default"
                                                    placeholder="******">
                                            </li>
                                            <li style="margin: 5px">
                                                <h2>رمز عبور جدید</h2>
                                            ...
                                            <input style="margin-top: 20px" id="submit-btn" class="input-group-text"
                                                type="button" onclick="UpdateProfile()" value="بروزرسانی اطلاعات"></input>
                                        </form>
                                    </div>
                                </div>
                            </div>
