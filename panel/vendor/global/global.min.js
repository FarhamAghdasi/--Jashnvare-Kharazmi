...
function dezSettings({typography, version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, primary}) {
    this.typography = typography || "vazirmatn";
...
dezSettings.prototype.manageTypography = function() {
    switch(this.typography) {
        default: 
            body.attr("data-typography", "vazirmatn");
    }
}
